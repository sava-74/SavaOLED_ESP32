Принято. Вы абсолютно правы: документация должна быть исчерпывающей, чтобы библиотекой можно было пользоваться, не заглядывая в исходный код.

Ниже представлен **полный список всех публичных функций** (Public API) библиотеки `SavaOLED_ESP32`, основанный на последней версии вашего заголовочного файла.
